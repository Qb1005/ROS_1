...
let RunMotionGoal = require('./RunMotionGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class RunMotionActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunMotionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunMotionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RunMotionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RunMotionGoal()
    }
...
module.exports = RunMotionActionGoal;
