...
let BuildMotionFeedback = require('./BuildMotionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class BuildMotionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new BuildMotionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BuildMotionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BuildMotionActionFeedback(null);
    ...
    data.feedback = BuildMotionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BuildMotionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = BuildMotionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new BuildMotionFeedback()
    }
...
module.exports = BuildMotionActionFeedback;
