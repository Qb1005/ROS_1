...
let RunMotionFeedback = require('./RunMotionFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class RunMotionActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new RunMotionFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RunMotionFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RunMotionActionFeedback(null);
    ...
    data.feedback = RunMotionFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RunMotionActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = RunMotionFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new RunMotionFeedback()
    }
...
module.exports = RunMotionActionFeedback;
