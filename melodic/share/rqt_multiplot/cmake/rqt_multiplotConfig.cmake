...
if("FALSE" STREQUAL "TRUE")
  set(rqt_multiplot_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-rqt-multiplot-0.0.10)
  set(rqt_multiplot_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-rqt-multiplot-0.0.10/obj-x86_64-linux-gnu/devel)
  ...
  set(rqt_multiplot_INSTALL_PREFIX /opt/ros/melodic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_multiplot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rqt_multiplot_NUM_DUMMY_TARGETS)
      set(rqt_multiplot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rqt_multiplot::wrapped-linker-option${rqt_multiplot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rqt_multiplot_NUM_DUMMY_TARGETS "${rqt_multiplot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rqt_multiplot::wrapped-linker-option${rqt_multiplot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rqt_multiplot_LIBRARIES "${interface_target_name}")
