...
"""autogenerated by genpy from play_motion_builder_msgs/RunMotionActionResult.msg. Do not edit."""
import codecs
import sys
...
class RunMotionActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "play_motion_builder_msgs/RunMotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','play_motion_builder_msgs/RunMotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunMotionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = play_motion_builder_msgs.msg.RunMotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = play_motion_builder_msgs.msg.RunMotionResult()
