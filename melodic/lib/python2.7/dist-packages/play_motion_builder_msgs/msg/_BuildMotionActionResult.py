...
"""autogenerated by genpy from play_motion_builder_msgs/BuildMotionActionResult.msg. Do not edit."""
import codecs
import sys
...
class BuildMotionActionResult(genpy.Message):
  _md5sum = "35d657a039282bf32a3510bd22eaeae1"
  _type = "play_motion_builder_msgs/BuildMotionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','play_motion_builder_msgs/BuildMotionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BuildMotionActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = play_motion_builder_msgs.msg.BuildMotionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = play_motion_builder_msgs.msg.BuildMotionResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.ok,) = _get_struct_B().unpack(str[start:end])
