...
"""autogenerated by genpy from play_motion_builder_msgs/RunMotionAction.msg. Do not edit."""
import codecs
import sys
...
class RunMotionAction(genpy.Message):
  _md5sum = "57a10b77720536607404de3a23075f21"
  _type = "play_motion_builder_msgs/RunMotionAction"
...
"""
  ...
  _slot_types = ['play_motion_builder_msgs/RunMotionActionGoal','play_motion_builder_msgs/RunMotionActionResult','play_motion_builder_msgs/RunMotionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RunMotionAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = play_motion_builder_msgs.msg.RunMotionActionGoal()
      if self.action_result is None:
        self.action_result = play_motion_builder_msgs.msg.RunMotionActionResult()
      if self.action_feedback is None:
        self.action_feedback = play_motion_builder_msgs.msg.RunMotionActionFeedback()
    else:
      self.action_goal = play_motion_builder_msgs.msg.RunMotionActionGoal()
      self.action_result = play_motion_builder_msgs.msg.RunMotionActionResult()
      self.action_feedback = play_motion_builder_msgs.msg.RunMotionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_BfH3I().pack(_x.action_goal.goal.run_mode, _x.action_goal.goal.downshift, _x.action_goal.goal.step_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.run_mode, _x.action_goal.goal.downshift, _x.action_goal.goal.step_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_BfH3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_B():
    ...
    return _struct_B
_struct_BfH3I = None
def _get_struct_BfH3I():
    global _struct_BfH3I
    if _struct_BfH3I is None:
        _struct_BfH3I = struct.Struct("<BfH3I")
    return _struct_BfH3I
