...
"""autogenerated by genpy from play_motion_builder_msgs/BuildMotionAction.msg. Do not edit."""
import codecs
import sys
...
class BuildMotionAction(genpy.Message):
  _md5sum = "455cd360788835a49638c295be24e0cf"
  _type = "play_motion_builder_msgs/BuildMotionAction"
...
"""
  ...
  _slot_types = ['play_motion_builder_msgs/BuildMotionActionGoal','play_motion_builder_msgs/BuildMotionActionResult','play_motion_builder_msgs/BuildMotionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BuildMotionAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = play_motion_builder_msgs.msg.BuildMotionActionGoal()
      if self.action_result is None:
        self.action_result = play_motion_builder_msgs.msg.BuildMotionActionResult()
      if self.action_feedback is None:
        self.action_feedback = play_motion_builder_msgs.msg.BuildMotionActionFeedback()
    else:
      self.action_goal = play_motion_builder_msgs.msg.BuildMotionActionGoal()
      self.action_result = play_motion_builder_msgs.msg.BuildMotionActionResult()
      self.action_feedback = play_motion_builder_msgs.msg.BuildMotionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_goal.goal.motion
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_result.result.ok
      buff.write(_get_struct_B().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.motion = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.motion = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_result.result.ok,) = _get_struct_B().unpack(str[start:end])
