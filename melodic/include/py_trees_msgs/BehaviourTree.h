...
struct BehaviourTree_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::py_trees_msgs::Behaviour_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::py_trees_msgs::Behaviour_<ContainerAllocator> >::other >  _behaviours_type;
