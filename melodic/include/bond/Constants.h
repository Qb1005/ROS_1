...
#if defined(_WIN32) && defined(DEAD_PUBLISH_PERIOD)
  #undef DEAD_PUBLISH_PERIOD
#endif
#if defined(_WIN32) && defined(DEFAULT_CONNECT_TIMEOUT)
  #undef DEFAULT_CONNECT_TIMEOUT
#endif
#if defined(_WIN32) && defined(DEFAULT_HEARTBEAT_TIMEOUT)
  #undef DEFAULT_HEARTBEAT_TIMEOUT
#endif
#if defined(_WIN32) && defined(DEFAULT_DISCONNECT_TIMEOUT)
  #undef DEFAULT_DISCONNECT_TIMEOUT
#endif
#if defined(_WIN32) && defined(DEFAULT_HEARTBEAT_PERIOD)
  #undef DEFAULT_HEARTBEAT_PERIOD
#endif
#if defined(_WIN32) && defined(DISABLE_HEARTBEAT_TIMEOUT_PARAM)
  #undef DISABLE_HEARTBEAT_TIMEOUT_PARAM
#endif
