...
bool operator==(const ::bond::Status_<ContainerAllocator1> & lhs, const ::bond::Status_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.id == rhs.id &&
    lhs.instance_id == rhs.instance_id &&
    lhs.active == rhs.active &&
    lhs.heartbeat_timeout == rhs.heartbeat_timeout &&
    lhs.heartbeat_period == rhs.heartbeat_period;
}
